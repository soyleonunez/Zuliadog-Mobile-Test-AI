...
class PacientesPage extends StatelessWidget {
                    ...
                    child: Center(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Aquí podrás gestionar todos los pacientes y mascotas',
  ...
  void _handleNavigation(BuildContext context, String route) {
    ...
    } else if (route == 'frame_pacientes') {
      // Ya estamos en pacientes
    } else {
